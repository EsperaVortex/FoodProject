    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            Object.entries(formData).forEach(([key, val]) => {
                // ✅ Skip preview (blob URL) and null image
                if (key === 'preview' || val === null) return;
            ...
            showNotification('Item added to menu successfully!', 'success');
                ...
                <div className={styles.formCard}>
                    ...
                    <form className='space-y-6 sm:space-y-8' onSubmit={handleSubmit}>
                        ...
                        <div className='space-y-6'>
                            ...
                            {/* ✅ Description — label now inside its own div */}
                            <div>
                                <label className='block mb-2 text-base sm:text-lg text-amber-400'>
                                    Description
                                </label>
