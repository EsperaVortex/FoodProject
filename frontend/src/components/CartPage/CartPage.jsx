  ...
  return (
    <div className="min-h-screen bg-[#1b120b] text-white px-4 py-12">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl sm:text-5xl font-bold text-center text-amber-400 mb-12 font-[Playfair_Display] italic">
          Your Cart
        </h1>
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {cartItems.map(({ _id, name, price, imageUrl, quantity }) => (
                <div
                  key={_id}
                  className="bg-[#2a1d14]/80 border border-amber-800/30 rounded-xl shadow-md overflow-hidden flex flex-col hover:shadow-amber-800/40 transition"
                >
                  {/* Image */}
                  <div
                    className="h-44 bg-black/10 cursor-pointer flex items-center justify-center"
                    onClick={() => setSelectedImage(buildImageUrl(imageUrl))}
                  >
                    <img
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    ...
                    <p className="text-sm text-amber-200 mt-1 mb-3 font-cinzel">
            ...
            <div className="mt-12 border-t border-amber-800 pt-8 flex flex-col items-end">
              ...
              <div className="flex gap-4">
                ...
                <Link
                  to="/checkout"
                  className="bg-amber-600 hover:bg-amber-500 text-white px-8 py-2 rounded-full uppercase font-semibold"
                >
                  Checkout Now
                </Link>
              </div>
