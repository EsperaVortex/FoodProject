...
const OurMenu = () => {
  ...
  // ✔ FIXED — now cart lookup uses correct structure (ci._id instead of ci.item._id)
            ...
            return (
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-grow">
                  <h3 className="text-xl font-dancingscript text-amber-100 mb-1">
                    {item.name}
                  </h3>
                  <p className="text-sm text-amber-100/80 mb-4 font-cinzel">
                    {item.description}
                  </p>
